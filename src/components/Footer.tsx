      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            <div className="mb-6">
              <div className="text-lg font-medium mb-1">BPSpecs</div>
              <div className="text-sm text-gray-400">A Recipe Group Company</div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">About Recipe Group</a></li>
