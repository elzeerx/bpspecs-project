              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    className="w-4 h-4 text-bpspecs-teal border-bpspecs-taupe/30 rounded focus:ring-bpspecs-teal"
                    disabled={isLoading}
                  />
                ...
                <Link
                  to="/forgot-password"
                  className="text-sm text-bpspecs-teal hover:underline font-medium"
                >
                  Forgot password?
                </Link>
              </div>
